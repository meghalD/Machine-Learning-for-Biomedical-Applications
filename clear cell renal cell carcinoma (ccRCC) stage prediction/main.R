#R scripts on Data Mining and ML in healthcare
#Meghal Dani, M.Tech CB

#-------------------------------------------------------------------------------------------------------------------------------
#Calculate mean and standard deviation (sd) of each gene in Early and Late stage samples. 
...
#---------------------------------------------------------------------------------------------------------------------------------------
#Find the enrichment of various Gene Ontology terms for the genes 
...
#----------------------------------------------------------------------------------------------------------------------------------------
#Divide the Dataset into 80:20 for training and validation for developing machine learning models 
...
#---------------------------------------------------------------------------------------------------------------------------------------
#Using features calculated above, develop machine learning models using at least three techniques (e.g. SVM, Logistic Regression, Random Forest) 
...
#-------------------------------------------------------------------------------------------------------------------------------------------------
#Using grid search find optimal parameters for your classifier and develop a model on 80% training data and validate on 20% data. 
...
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
#Report accuracy, sensitivity, specificity, and ROC on training data and validation data in
...
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#Cluster your data using K-Means clustering and find the number of optimal clusters using Silhouette distance. 
